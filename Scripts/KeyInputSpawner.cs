...
public class KeyInputSpawner : MonoBehaviour
{
    ...
    {
        Debug.Log("Called");
        spawnMoveSpeed = Difficulty.moveSpeed;       //KeyInputBehavior sets moveSpeed
        ...
        if (isThisNoteHeldOrTapped())                                               //Determines whether the input requires either a 'hold' or 'tap'
        {
